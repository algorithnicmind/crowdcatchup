      ...
      >
        ...
        >
          <div className="px-5 py-4 border-b border-white/10 flex items-center justify-between">
            ...
            <div className="text-[10px] text-zinc-500 font-mono">ID: ZN-04</div>
          </div>
          ...
          <div className="p-5 space-y-5">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1.5">
                ...
                <div className="bg-black/50 border border-white/10 rounded-md px-3 py-1.5 text-sm text-zinc-300">
                  Zone (High Density)
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 flex gap-2">
              <Button className="flex-1 bg-purple-600 hover:bg-purple-500 text-white shadow-lg shadow-purple-500/20">
                <Save className="w-4 h-4 mr-2" /> Save
              </Button>
              <Button variant="outline" className="w-10 p-0 border-white/10 text-red-400 hover:text-red-300 hover:bg-red-500/10">
