...
export function RoutingPanel() {
  ...
  if (!isOpen) {
    return (
      <button 
        ...
        className="absolute top-20 md:top-16 left-4 md:left-6 z-50 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 md:py-3 px-4 md:px-6 rounded-full shadow-lg transition-colors flex items-center gap-2 pointer-events-auto"
      >
  ...
  return (
    <div className="absolute top-20 md:top-16 left-4 md:left-6 z-50 w-[calc(100vw-32px)] md:w-80 bg-zinc-950/95 backdrop-blur-xl border border-zinc-800 rounded-2xl shadow-2xl overflow-hidden animate-in slide-in-from-left-4 fade-in duration-300 pointer-events-auto">
