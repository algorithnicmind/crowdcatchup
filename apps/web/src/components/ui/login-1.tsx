  ...
  return (
    <div className="w-full min-w-[200px] relative text-left">
      ...
      <div className="relative w-full">
        <input
          type="text"
          className="peer relative z-10 border-2 border-[var(--color-border)] h-13 w-full rounded-md bg-[var(--color-surface)] px-4 py-2 font-thin outline-none drop-shadow-sm transition-all duration-200 ease-in-out focus:bg-[var(--color-bg)] placeholder:font-medium text-white"
...
export const LoginOne = () => {
  ...
  return (
    ...
    <div className='card w-[80%] lg:w-[70%] md:w-[55%] flex justify-between h-[600px] bg-[var(--color-surface)] rounded-3xl overflow-hidden'>
      <div
          ...
          <div className="form-container sign-in-container h-full z-10 relative">
            <form className='text-center py-10 md:py-20 grid gap-2 h-full' onSubmit={(e)=>{e.preventDefault();}}>
              <div className='grid gap-4 md:gap-6 mb-2'>
                <h1 className='text-3xl md:text-4xl font-extrabold text-white' onClick={(e) => {e.preventDefault()}}>Sign in</h1>
                        ...
                        return (
                          <li key={index} className="list-none">
                            ...
                            >
                              ...
                              />
                              <span className="text-[1.5rem] text-zinc-400 transition-all duration-500 ease-in-out z-[2] group-hover:text-white group-hover:rotate-y-360">
                                {social.icon}
                              </span>
                            </a>
                          </li>
              ...
              <span className='text-sm text-zinc-400'>or use your account</span>
            </div>
            <div className='grid gap-4 items-center'>
                <AppInput placeholder="Email" type="email" />
                <AppInput placeholder="Password" type="password" />
              </div>
              <a href="#" className='font-light text-sm md:text-md text-blue-500'>Forgot your password?</a>
